package com.tvpc.bootstrap;

import com.tvpc.domain.model.SettlementEvent;
import com.tvpc.infrastructure.adapter.incoming.http.HttpServerVerticle;
import com.tvpc.infrastructure.adapter.incoming.messaging.SettlementEventCodec;
 ...
 * Bootstrap layer that wires everything together and starts the application
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Deploy HTTP Server Verticle (infrastructure adapter)
